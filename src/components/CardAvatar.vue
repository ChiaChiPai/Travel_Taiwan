...
<template>
  <div class="border-[2px] border-[rgba(0, w-[368px] 0, 0.3">
    <img
      class="
        max-w-[128px]
        transform
    ...
    <img
      ...
      alt="" />
    <div class="bg-[#0f0] rounded-t-[30px] h-[256px] mb-[8px] w-[100%]" />
    <div class="px-[15px]">
      <h3
        class="
          mr-[12px]
      ...
      <ul
        ...
        ">
        <li>
          <img src="@/assets/svg/icon_eye.svg" alt="" />
          <span>3萬</span>
        </li>
        <li>
          <img src="@/assets/svg/icon_love.svg" alt="" />
          <span>3千</span>
        </li>
      </ul>
    </div>
